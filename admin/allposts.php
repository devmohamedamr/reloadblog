...
<div class="wrapper">
            ...
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <img src="img/30742063_1715311778562340_429300947810779136_n.jpg" class="user-image" alt="User Image">
                            <span class="hidden-xs">kareem omar</span>
                        </a>
                        <ul class="dropdown-menu">
                            <!-- User image -->
                            <li class="user-header">
                                <img src="img/30742063_1715311778562340_429300947810779136_n.jpg" class="img-circle" alt="User Image">

                                <p>
                                    kareem omar - Web Developer
            ...
            <ul class="sidebar-menu" data-widget="tree">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li class="active"><a href="addnewpost.php"><i class="fa fa-circle-o"></i> Add new post</a></li>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                Show Post Informtion
                <small>preview of Show Post Informtion</small>
            </h1>
        </section>
            ...
            <div class="box-body no-padding">
                <table class="table table-condensed">
                    ...
                    <tr>
                        ...
                        <td><?=$p["title"] ?></td>
                        <td><?=$p["artical"] ?></td>
                        <td><img width="100px" height="100px" src="img/<?= $p['img']; ?>" /></td>
                        <td><a href="deletedpost.php?id=<?=$p["id"]; ?>" >Delet</a></td>
                    </tr>
                    <?php endforeach; ?>
                </table>
            </div>
