...
if(isset($_POST['update'])){
    ...
    //----------------------------------------
    $update = UpdateUserInfo($id,$name,$password,$email,$NewImgName);
                        ...
                        <form class="form-horizontal" action="updateuser.php" method="post" enctype="multipart/form-data">
                            ...
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="fullname" value="<?= $userdata[0]['name']; ?>" class="form-control" id="inputEmail3" placeholder="full name">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" value="<?= $userdata[0]['email']; ?>" name="email" id="inputEmail3" placeholder="email">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <img src="../img/<?= $userdata[0]['img']; ?>" width="200px" height="200px" />
                                <div class="form-group">
